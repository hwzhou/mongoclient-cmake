...
namespace mongo {
     ...
     */
    MONGO_CLIENT_API Status bsonExtractField(const BSONObj& object,
     ...
     */
    MONGO_CLIENT_API Status bsonExtractTypedField(const BSONObj& object,
                                                  const StringData& fieldName,
                                                  BSONType type,
                                                  BSONElement* outElement);
     ...
     */
    MONGO_CLIENT_API Status bsonExtractBooleanField(const BSONObj& object,
                                                    const StringData& fieldName,
                                                    bool* out);
     ...
     */
    MONGO_CLIENT_API Status bsonExtractStringField(const BSONObj& object,
                                                   const StringData& fieldName,
                                                   std::string* out);
     ...
     */
    MONGO_CLIENT_API Status bsonExtractBooleanFieldWithDefault(const BSONObj& object,
                                                               const StringData& fieldName,
                                                               bool defaultValue,
                                                               bool* out);
     ...
     */
    MONGO_CLIENT_API Status bsonExtractStringFieldWithDefault(const BSONObj& object,
                                                              const StringData& fieldName,
