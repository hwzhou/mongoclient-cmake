...
#pragma pack(1)
        class MONGO_CLIENT_API Holder : boost::noncopyable {
        private:
...
#pragma warning(default: 4275)
    ...
    MONGO_CLIENT_API std::ostream& operator<<( std::ostream &s, const BSONObj &o );
    MONGO_CLIENT_API std::ostream& operator<<( std::ostream &s, const BSONElement &e );

    MONGO_CLIENT_API StringBuilder& operator<<( StringBuilder &s, const BSONObj &o );
    MONGO_CLIENT_API StringBuilder& operator<<( StringBuilder &s, const BSONElement &e );


    struct MONGO_CLIENT_API BSONArray : BSONObj {
