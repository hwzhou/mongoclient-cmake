...
namespace mongo {
    ...
    extern MONGO_CLIENT_API AssertionCount assertionCount;
...
# define massert MONGO_massert
    ...
    MONGO_CLIENT_API MONGO_COMPILER_NORETURN void streamNotGood( int code, const std::string& msg, std::ios& myios );
    ...
    MONGO_CLIENT_API std::string demangleName( const std::type_info& typeinfo );
