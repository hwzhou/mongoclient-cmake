...
namespace mongo {
    ...
    */
    ...
    MONGO_CLIENT_API void flushMyDirectory(const boost::filesystem::path& file);

    MONGO_CLIENT_API boost::filesystem::path ensureParentDirCreated(const boost::filesystem::path& p);
