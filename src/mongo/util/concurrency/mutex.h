...
namespace mongo {
    ...
    class MONGO_CLIENT_API StaticObserver : boost::noncopyable {
    public:
     ...
     *  NOT recursive.
     */
    class MONGO_CLIENT_API mutex : boost::noncopyable {
    public:
        ...
        class MONGO_CLIENT_API try_lock : boost::noncopyable {
        public:
        ...
        class MONGO_CLIENT_API scoped_lock : boost::noncopyable {
        public:
#if defined(_DEBUG)
            struct MONGO_CLIENT_API PostStaticCheck {
                PostStaticCheck();
            } _check;
    ...
    */
     ...
     */
    class MONGO_CLIENT_API RecursiveMutex : boost::noncopyable {
    public:
