...
namespace mongo {
    ...
    class MONGO_CLIENT_API RWLock : public RWLockBase { 
    ...
    public:
        ...
        /** acquire upgradable state.  You must be unlocked before creating.
            ...
            in the interim.
            */
        class MONGO_CLIENT_API Upgradable : boost::noncopyable { 
            RWLock& _r;
        public:
    ...
    class MONGO_CLIENT_API rwlock_try_write : boost::noncopyable {
    public:
        struct MONGO_CLIENT_API exception { };
    ...
    class MONGO_CLIENT_API rwlock_shared : boost::noncopyable {
    public:
    ...
    class MONGO_CLIENT_API rwlock : boost::noncopyable {
    public:
        /**
    ...
    class MONGO_CLIENT_API RWLockRecursive : protected RWLockBase {
    protected:
    ...
    public:
        ...
        class MONGO_CLIENT_API Exclusive : boost::noncopyable { 
            RWLockRecursive& _r;
        public:
        ...
        class MONGO_CLIENT_API Shared : boost::noncopyable { 
            RWLockRecursive& _r;
    ...
    class MONGO_CLIENT_API RWLockRecursiveNongreedy : public RWLockRecursive { 
        virtual void Lock() { 
            bool got = false;
