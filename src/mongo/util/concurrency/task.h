...
namespace mongo {
    ...
    namespace task {
        ...
        */
        class MONGO_CLIENT_API Task : private BackgroundJob {
        protected:
        ...
        private:
            unsigned n, repeat;
            friend MONGO_CLIENT_API void fork(Task* t);
            friend MONGO_CLIENT_API void repeat(Task* t, unsigned millis);
            virtual void run();
            //virtual void ending() { }
            void begin();
        };
        ...
        /** run once */
        MONGO_CLIENT_API void fork(Task *t);

        /** run doWork() over and over, with a pause between runs of millis */
        MONGO_CLIENT_API void repeat(Task *t, unsigned millis);
