...
namespace mongo {
    ...
    MONGO_CLIENT_API void splitStringDelim( const std::string& str , std::vector<std::string>* res , char delim );

    MONGO_CLIENT_API void joinStringDelim( const std::vector<std::string>& strs , std::string* res , char delim );
    ...
    class MONGO_CLIENT_API LexNumCmp {
    public:
    ...
    MONGO_CLIENT_API int versionCmp(const StringData rhs, const StringData lhs);
