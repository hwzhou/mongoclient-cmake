 ...
 */
    class MONGO_CLIENT_API IntrusiveCounter :
        boost::noncopyable {
    public:
    ...
    class MONGO_CLIENT_API IntrusiveCounterUnsigned :
    ...
    class MONGO_CLIENT_API RefCountable : boost::noncopyable {
    public:
    ...
    class MONGO_CLIENT_API RCString : public RefCountable {
    public:
...
#if defined(_MSC_VER)
        void operator delete (void* ptr, size_t realSize) { free(ptr); }
#else
