...
namespace mongo {
     ...
     */
    MONGO_CLIENT_API const std::string getSSLVersion(const std::string &prefix, const std::string &suffix); 
}

#ifdef MONGO_SSL
namespace mongo {

    class MONGO_CLIENT_API SSLConnection {
    public:
        SSL* ssl;
        BIO* networkBIO;
        BIO* internalBIO;
    ...
    class MONGO_CLIENT_API SSLManagerInterface {
    public:
    ...
    MONGO_CLIENT_API SSLManagerInterface* getSSLManager();

    extern MONGO_CLIENT_API bool isSSLServer;
}
