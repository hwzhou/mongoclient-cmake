...
namespace logger {
     ...
     */
    class MONGO_CLIENT_API MessageEventDetailsEncoder : public Encoder<MessageEventEphemeral> {
    public:
     ...
     */
    class MONGO_CLIENT_API MessageEventWithContextEncoder : public Encoder<MessageEventEphemeral> {
    public:
     ...
     */
    class MONGO_CLIENT_API MessageEventUnadornedEncoder : public Encoder<MessageEventEphemeral> {
    public:
