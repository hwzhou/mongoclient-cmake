...
namespace mongo {
     ...
     */
    class MONGO_CLIENT_API RamLog : public logger::Tee {
     ...
     */
    class MONGO_CLIENT_API RamLog::LineIterator {
     ...
     */
    class MONGO_CLIENT_API RamLogAppender : public logger::Appender<logger::MessageEventEphemeral> {
    public:
