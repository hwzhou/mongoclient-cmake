...
#define EXPLICIT_INSTATIATION_TEMPLATE(TYPE) extern template class MONGO_CLIENT_API TYPE;
#elif !defined(LIBMONGOCLIENT_CONSUMER) && defined(LIBMONGOCLIENT_BUILDING)
#define MONGO_CLIENT_API MONGO_COMPILER_API_EXPORT
#define EXPLICIT_INSTATIATION_TEMPLATE(TYPE) template class MONGO_CLIENT_API TYPE;
#elif !defined(LIBMONGOCLIENT_CONSUMER) && !defined(LIBMONGOCLIENT_BUILDING)
#define MONGO_CLIENT_API
#define EXPLICIT_INSTATIATION_TEMPLATE(TYPE)
#else
